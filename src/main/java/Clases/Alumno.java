...
public class Alumno {
	...
	public Alumno(String centro, String rol, String nombre, String contrasenia, ArrayList<String> familiaProfesional, String contacto, Double puntuacion, ArrayList<Proyecto> proyectos) {
		this.centro = centro;
		this.rol = rol;
		this.nombre = nombre;
